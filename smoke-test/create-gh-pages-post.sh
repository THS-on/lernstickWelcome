...
sed -i -e s/REPLACE_DATE/$DATE/g smoke-test/gh-pages-template.markdown
...
cp /tmp/smoke/screenshot.png /tmp/gh-pages/images/${TRAVIS_COMMIT}.png
cp /tmp/smoke/welcomeapplication-0.0.1-SNAPSHOT.jar /tmp/gh-pages/jars/${TRAVIS_COMMIT}.jar
